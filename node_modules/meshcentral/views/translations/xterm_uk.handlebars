...
<body style="overflow:hidden;background-color:black" oncontextmenu="handleContextMenu(event)">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Оболонка Адміністратора</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">PowerShell від Адміністратора</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Оболонка користувача</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">Користувач PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        ...
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Оболонка користувача</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Лоґін у Оболонку</div>
    </div>
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0" style="position:relative">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="ConnectButton" style="display:none" type="button" value="Підключитися" onclick="connectButton()">
