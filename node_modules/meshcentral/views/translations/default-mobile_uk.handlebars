            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Сервер від'єднано</span>, <href onclick="reload()" style="cursor:pointer"><u>клікнути для поновлення підключення</u></href>.</div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Переглянути попередні лоґіни</a></span></div>
                            ...
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Немає груп пристроїв.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Розпочніть тут!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                        ...
                        <table id="p5toolbar" style="width:100%;height:78px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Передати" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Освіження" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        ...
                        <div style="padding:10px;margin-bottom:20px"><input type="button" value="ОК" style="float:right;width:80px" onclick="deskCustomizeKeysEx()"></div>
                    </div>
                        ...
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Повноекранне" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Підключитися" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Повноекранне" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Підключитися" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Підключитися" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Передати" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Освіження" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Дії Агента" onclick="p15uploadCore(event)">
                                    </div>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Агент Віддаленої Стільниці</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Якість
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Швидка</option>
                                    <option value="100">Середня</option>
                                    <option value="400">Повільна</option>
                                    <option value="1000">Дуже повільна</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Блокування при Відключенні</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            ...
            <input id="idx_dlgOkButton" type="button" value="ОК" style="float:right;width:80px" onclick="dialogclose(1)">
    ...
    <script>
        ...
        function onMessage(server, message) {
            switch (message.action) {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Застосунок Автентифікатора", 1, null, message.success ? "<b style=color:green>Двофакторну автентифікацію підтверджено</b>. Вам буде потрібен чинний токен для нового пікдключення." : "<b style=color:red>Двофакторна автентифікація невдала</b>. Очистіть ключ у застосунку та спробуйте ще раз. Ви маєте кілька хвилин для введеня дійсного коду.");
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Застосунок Автентифікатора", 1, null, message.success ? "<b style=color:green>Двофакторна автентифікація видалена</b>. Ви можете відновити цю властивість в будь-який момент." : "<b style=color:red>Видалення двофакторної автентифікації невдале</b>. Спробуйте ще раз.");
                    break;
                }
        ...
        */
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Завантажити Файл", 10, p13downloadFileCancel, '<div>' + HtmlEscape(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "ОК" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "КЕПСЬКО" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Оновлення" + ' - <span style=color:green>' + "ОК" + '</span>'); } else { y.push("Оновлення" + ' - <span style=color:red>' + "КЕПСЬКО" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Фаєрвол" + ' - <span style=color:green>' + "ОК" + '</span>'); } else { y.push("Фаєрвол" + ' - <span style=color:red>' + "КЕПСЬКО" + '</span>'); } }
            ...
            if(node.defender && !node.wsc) {
                ...
                x += addDetailItem("Захисник Windows", y.join(', '));
            }
        ...
        */
        ...
        function p15uploadCore(e) {
            ...
            else { setDialogMode(2, "Виконати дію агента", 3, p15uploadCoreEx, addHtmlValue("Дія", '<select id=d3coreMode style=width:230px><option value=1>' + "Передати ядро ​​сервера за умовчанням" + '</option><option value=2>' + "Очистити ядро" + '</option><option value=6>' + "Передати ядро для ​​відновлення" + '</option><option value=7>' + "Передати спрощене ядро" + '</option><option value=3>' + "Передати файл ядра" + '</option><option value=4>' + "М'яке відключення агенту" + '</option><option value=5>' + "Жорстке відключення агента" + '</option><option value=8>' + "Restart agent service" + '</select>')); }
        }
