    ...
    <script>
        ...
        */
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Download bestand", 10, p13downloadFileCancel, '<div>' + HtmlEscape(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.tpm) {
                ...
                if (tpm.IsActivated != null) { x += addDetailItem("IsActivated", (tpm.IsActivated ? "Ja" : "Nee"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("IsEnabled", (tpm.IsEnabled ? "Ja" : "Nee"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("IsOwned", (tpm.IsOwned ? "Ja" : "Nee"), s); }
