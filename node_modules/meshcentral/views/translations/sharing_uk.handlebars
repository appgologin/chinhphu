...
<body style="overflow:hidden;background-color:black">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                ...
                <div>
                    ...
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Підключитися" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
    ...
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        ...
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            ...
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Підключитися" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                ...
                <div>
                    <input id="p13Connect" value="Підключитися" onclick="connectFiles(event)" type="button">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    ...
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Передати" onclick="p13uploadFile()">&nbsp;
                    ...
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="Освіження" onclick="p13folderup(9999)">&nbsp;
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    <h4>Агент Віддаленої Стільниці</h4>
                    <div>
                        <div>Якість</div>
    ...
    <script>
        ...
        */
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Підключитися" : "Відключити";
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Назва zip-файлу", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip -r', path: p13filetreelocation.join('/'), files: inputFiles });
